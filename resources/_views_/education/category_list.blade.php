                            ...
                            @foreach ($list as $key => $value)
                              <tr>
                                ...
                                <td class="px-0" style="width:120px;">
                                    ...
                                    <a href='/education/lessons/{{$value->id}}'><i class="fas fa-photo-video text-danger  mx-2"></i></a>
                                    <a href='/delete/education/category/{{$value->id}}' onclick="return confirm('Silmek İstediğinize Emin misiniz?')"><i class="fas fa-times text-danger  mx-2"></i></a>
                                </td>
                              </tr>
                            @endforeach
                          @endif
