...
@section('content')
  ...
  .smallx {font-size:0.8em !important;font-weight: bold;}
    ...
    <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="card-title pl-1"><strong> Sınav Soru Grubu Tanımlama </strong> <a href='javascript:void(0)' class="btn btn-danger btn-sm float-right"  onclick="add()"><i class="fas fa-plus"></i>  Yeni Soru Grubu Tanımı</a></div>
                      ...
                      <div class="col-12 text-right">
                            ...
                            <div class="table-responsive" style="width:100%">
                              ...
                              <table class="table">
                                <thead>
                                  <th>Id</th>
                                  <th>Soru Grubu Tanımı</th>
                                  <th>soru Grubu Açıklaması</th>
                                  <th>İşlemler</th>
                                </thead>
                                <tbody>
                                @foreach ($list as $key => $value)
                                    <tr>
                                      ...
                                      <td style="width:150px">
                                        ...
                                        <a class="text-danger mx-3" href='/parametreler/sinav/soru/delete/{{$value->id}}' onclick="return confirm('Silmek İstediğinize Emin misiniz?')"><i class="fa fa-times"></i></a>
                                      </td>
                                    </tr>
                                @endforeach
                              </tbody>
              ...
              <div class="modal-dialog modal-xxl" role="document">
                <div class="modal-content">
                  <div class="modal-header  bg-qpm-dark text-white">
                    ...
                    <form class="w-100" method="POST"  action="/parametreler/sinav/soru/save" id="actionX">
              ...
              <div class="modal-dialog modal-xxl" role="document">
                <div class="modal-content">
                  <div class="modal-header  bg-qpm-dark text-white">
                    ...
                    <form class="w-100" method="POST"  action="/parametreler/sinav/soru/update" id="actionXE">
...
{
  $.ajax({
         url: "/parametreler/sinav/soru/edit/"+id,
      ...
      {
        $.ajax({
               url: "/parametreler/sinav/soru/add",
               beforeSend:function(x){
