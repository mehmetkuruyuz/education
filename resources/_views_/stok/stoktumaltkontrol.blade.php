...
@section('content')
  ...
  td {font-size:0.8em !important;}
    ...
    <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="card-title pl-1"><strong>Stok {{$title}} Tanımlama</strong> <a href='javascript:void(0)' class="btn btn-danger btn-sm float-right" data-toggle="modal" data-target="#altislem"><i class="fas fa-plus"></i>  Yeni {{$title}}</a></div>
                            ...
                            @foreach ($list as $key => $value)
                              <tr>
                                ...
                                <td class="px-0" style="width:150px;">
                                  ...
                                  <a href='/stok/delete/{{$type}}/{{$value->id}}' onclick="return confirm('Silmek İstediğinize Emin misiniz?')" class="text-danger  mx-3"><i class="fa fa-times"></i></a>
                                </td>
                              </tr>
                            @endforeach
                          @endif
                ...
                <div class="modal-dialog modal-xxl" role="document">
                  <div class="modal-content">
                    <div class="modal-header  bg-qpm-dark text-white">
                      ...
                      <form class="w-100 p-5" method="POST"  action="/stok/save" id="actionX">
                        {{csrf_field()}}
