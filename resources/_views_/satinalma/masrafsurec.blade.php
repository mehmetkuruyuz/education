...
@section('content')
  ...
  <div class="container-fluid my-3">
        ...
        <div class="card">
          <div class="card-body">
          <div class="card-title pl-1"><strong>Satın Alma Talep Süreç Tanımlama</strong>  <a href='/tanimlama/masraf/sablon' class="btn btn-danger btn-sm float-right"><i class="fas fa-plus"></i> Genel Süreç Tanımlama</a></div>
          <div class="col-md-12">
            <div class="box  my-3">
