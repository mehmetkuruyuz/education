                          ...
                          @if (!empty($list))
                            @foreach ($list as $key => $value)
                              <tr>
                                ...
                                <td class="px-0" style="width:20px;"><a title="İstatistik" href='/exam/statics/{{$value->id}}'><i class="far fa-question-circle"></i></a></td>
                                <td class="px-0" style="width:20px;"><a title="Sorular" href='/admin/sinav/questions/list/{{$value->id}}'><i class="far fa-question-circle"></i></a></td>
                                <td class="px-0" style="width:20px;"><a title="Düzenle" href='/admin/sinav/edit/{{$value->id}}'><i class="fa fa-edit"></i></a></td>
                              </tr>
                            @endforeach
                          @endif
                        </tbody>
