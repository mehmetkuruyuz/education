                            ...
                            @foreach ($list as $key => $value)
                              <tr>
                                ...
                                <td class="px-0" style="width:180px;">
                                    ...
                                    <a href='/delete/poll/question/{{$value->id}}' onclick="return confirm('Silmek İstediğinize Emin misiniz?')"><i class="fas fa-times text-danger  mx-2"></i></a>
                                </td>
                              </tr>
                            @endforeach
                          @endif
      ...
      <div class="modal-dialog  modal-xxl" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body ">
            <form class="w-100" method="POST" action="/poll/save/answer/{{$id}}" enctype="multipart/form-data" id='dataFrm'>
              {{csrf_field()}}
