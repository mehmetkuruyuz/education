                          ...
                          @if (!empty($list))
                            @foreach ($list as $key => $value)
                              <tr>
                                ...
                                <td>{{$title}}</td>
                                  <td>{{\Carbon\Carbon::parse($value->baslangictarihi)->format("d-m-Y")}}</td>
                                  <td>{{\Carbon\Carbon::parse($value->tamamlanmaTarihi)->format("d-m-Y")}}</td>
                                <td class="px-0" style="width:140px;">
                                    <a href='javascript:void(0)' onclick="openInformation('{{$value->id}}')"   title="Dersleri Düzenle"><i class="fa fa-edit text-danger mx-2"></i></a>
                                    <a href='javascript:void(0)' onclick="openUsersInformation('{{$value->id}}')" title="Kullanıcı Atama"><i class="fas fa-users text-danger mx-2"></i></a>
                                    <a href='/delete/education/{{$value->id}}'  title="Ders Sil" onclick="return confirm('Silmek İstediğinize Emin misiniz?')"><i class="fas fa-times text-danger  mx-2"></i></a>
                                </td>
                              </tr>
                            @endforeach
                          @endif
                ...
                <form class="w-100" method="POST" action="/education/save" enctype="multipart/form-data">
                    ...
                    <div class="form-group p-2">
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="customFile" name="video" onchange="getFileName(this)">
                            <label class="custom-file-label" for="customFile" id="filesd">Eğitim Dosyası</label>
                        </div>
                    </div>
                  ...
                  <div class="form-group p-2 d-none">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input id="" type="text" class="form-control daterange" name="baslangictarihi" value="" >
                        </div>
                    </div>
                    <div class="form-group">
  ...
  $(document).ready(function (){
    ...
    function openInformation(id) {
      ...
      function getFileName(input) {
          $("#filesd").html(input.files[0].name+" Dosya seçildi.");
