...
@section('content')
  ...
  <div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <div class="card-title pl-1"><strong>@if ($ty=="done") Tamamlanan Sınav Listem @else Sınav Listem @endif</strong></div>
                ...
                @foreach ($list as $z => $ze)
                    @if (!empty($ze->poll))
                          ...
                          <tr>
                            ...
                            @if ($ze->tamamlandi=="no")
                              <td><a href='/sinav/start/user/{{$ze->poll->id}}' class="text-danger"><i class="fas fa-hourglass-start"></i></a></td>
                            @else
                              <td><a href='/sinav/show/user/{{$ze->poll->id}}' class="text-danger"><i class="fas fa-hourglass-start"></i></a></td>
                            @endif
