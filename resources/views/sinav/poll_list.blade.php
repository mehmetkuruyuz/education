                            ...
                            @foreach ($list as $key => $value)
                              <tr>
                                ...
                                <td class="px-0" style="width:180px;">
                                    <a href='javascript:void(0)' onclick="openInformation('{{$value->id}}')"  title="Sınavı Düzenle"><i class="fa fa-edit text-danger mx-2"></i></a>
                                    <a href='javascript:void(0)' onclick="openUsersInformation('{{$value->id}}')"  title="Sınava Kullanıcı Ata"><i class="fas fa-users text-danger mx-2"></i></a>
                                    <a href='/sinav/question/{{$value->id}}'><i class="far  fa-question-circle text-danger  mx-2"  title="Sınav Soruları Düzenle"></i></a>
                                    <a href='/delete/sinav/{{$value->id}}' onclick="return confirm('Silmek İstediğinize Emin misiniz?')"  title="Sınavı Sil"><i class="fas fa-times text-danger  mx-2"></i></a>
                                </td>
                              </tr>
                            @endforeach
                          @endif
