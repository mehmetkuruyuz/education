...
<div class="container-fluid my-3">
  <div class="row justify-content-center">
    <div class="col-md-12">
      <div class="card">
        <div class="card-body">
          <div class="card-title pl-1"><strong>Tedarik Edilen Talepler</strong>

          </div>
          <form action="/teklif/tamamlanmis" method="post" >
            {{csrf_field()}}
                        ...
                        <table class="table">
                          <thead>
                            <tr>
                              ...
                              <th class="smallxd">Tedarik Tarihi</th>
                            ...
                            @foreach ($list as $klo => $vlo)
                              <tr>
                                ...
                                <td>{{\Carbon\Carbon::parse($vlo->teminedildi)->format("d-m-Y H:i")}}</td>
                                  ...
                                  <td colspan="10">
                                        <table class="table">
                                          <thead>
                                            ...
                                            @foreach ($vlo->tekliftamamlandi as $top => $deger)
                                              <tr>
                                                <td>
